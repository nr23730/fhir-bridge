...
public class HeartRateCompositionConverter
    implements CompositionConverter<HerzfrequenzComposition, Observation> {
  ...
  public HerzfrequenzComposition toComposition(Observation observation) {
    ...
    try {
      ...
      herzfrequenzObservation.setFrequenzMagnitude(
          observation.getValueQuantity().getValue().doubleValue());
      herzfrequenzObservation.setFrequenzUnits(
          observation
              .getValueQuantity()

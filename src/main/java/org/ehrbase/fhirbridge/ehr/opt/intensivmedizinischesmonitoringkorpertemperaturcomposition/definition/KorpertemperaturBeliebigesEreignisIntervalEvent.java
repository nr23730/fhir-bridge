...
import org.ehrbase.fhirbridge.ehr.opt.shareddefinition.MathFunctionDefiningcode;

@Entity
@OptionFor("INTERVAL_EVENT")
public class KorpertemperaturBeliebigesEreignisIntervalEvent
    implements KorpertemperaturBeliebigesEreignisChoice {
  @Path("/time|value")

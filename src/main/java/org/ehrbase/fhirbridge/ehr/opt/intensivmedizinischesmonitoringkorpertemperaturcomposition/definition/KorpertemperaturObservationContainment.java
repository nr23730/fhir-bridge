...
public class KorpertemperaturObservationContainment extends Containment {
  ...
  public ListSelectAqlField<KorpertemperaturBeliebigesEreignisChoice> BELIEBIGES_EREIGNIS =
      new ListAqlFieldImp<KorpertemperaturBeliebigesEreignisChoice>(
          KorpertemperaturObservation.class,
          "/data[at0002]/events[at0003]",
          "beliebigesEreignis",
          KorpertemperaturBeliebigesEreignisChoice.class,
          this);
  ...
  public SelectAqlField<KorpertemperaturLokalisationDerMessungChoice> LOKALISATION_DER_MESSUNG =
      new AqlFieldImp<KorpertemperaturLokalisationDerMessungChoice>(
          KorpertemperaturObservation.class,
          "/protocol[at0020]/items[at0021]/value",
          "lokalisationDerMessung",
          KorpertemperaturLokalisationDerMessungChoice.class,
          this);

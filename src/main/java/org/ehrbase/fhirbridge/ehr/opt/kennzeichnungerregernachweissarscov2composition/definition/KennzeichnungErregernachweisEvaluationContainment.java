...
public class KennzeichnungErregernachweisEvaluationContainment extends Containment {
  public SelectAqlField<KennzeichnungErregernachweisEvaluation>
      KENNZEICHNUNG_ERREGERNACHWEIS_EVALUATION =
          new AqlFieldImp<KennzeichnungErregernachweisEvaluation>(
              KennzeichnungErregernachweisEvaluation.class,
              "",
              "KennzeichnungErregernachweisEvaluation",
              KennzeichnungErregernachweisEvaluation.class,
              this);

  public SelectAqlField<Boolean> ERREGERNACHWEIS_VALUE =
      new AqlFieldImp<Boolean>(
          KennzeichnungErregernachweisEvaluation.class,
          "/data[at0001]/items[at0005]/value|value",
          "erregernachweisValue",
          Boolean.class,
          this);
  ...
  public ListSelectAqlField<Cluster> ERWEITERUNG =
      new ListAqlFieldImp<Cluster>(
          KennzeichnungErregernachweisEvaluation.class,
          "/protocol[at0003]/items[at0007]",
          "erweiterung",
          Cluster.class,
          this);

  public SelectAqlField<TemporalAccessor> ZEITPUNKT_DER_KENNZEICHNUNG_VALUE =
      new AqlFieldImp<TemporalAccessor>(
          KennzeichnungErregernachweisEvaluation.class,
          "/data[at0001]/items[at0015]/value|value",
          "zeitpunktDerKennzeichnungValue",
          TemporalAccessor.class,
          this);

  public SelectAqlField<ErregernameDefiningcode> ERREGERNAME_DEFININGCODE =
      new AqlFieldImp<ErregernameDefiningcode>(
          KennzeichnungErregernachweisEvaluation.class,
          "/data[at0001]/items[at0012]/value|defining_code",
          "erregernameDefiningcode",
          ErregernameDefiningcode.class,
          this);

  public SelectAqlField<String> HINWEISTEXT_VALUE =
  ...
  public SelectAqlField<Boolean> ERREGERNACHWEIS_IN_DER_KLINIK_VALUE =
      new AqlFieldImp<Boolean>(
          KennzeichnungErregernachweisEvaluation.class,
          "/data[at0001]/items[at0011]/value|value",
          "erregernachweisInDerKlinikValue",
          Boolean.class,
          this);
  ...
  public SelectAqlField<TemporalAccessor> ZULETZT_AKTUALISIERT_VALUE =
      new AqlFieldImp<TemporalAccessor>(
          KennzeichnungErregernachweisEvaluation.class,
          "/protocol[at0003]/items[at0004]/value|value",

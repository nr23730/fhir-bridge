...
public class IntensivmedizinischesMonitoringKorpertemperaturCompositionContainment
    extends Containment {
  public SelectAqlField<IntensivmedizinischesMonitoringKorpertemperaturComposition>
      INTENSIVMEDIZINISCHES_MONITORING_KORPERTEMPERATUR_COMPOSITION =
          new AqlFieldImp<IntensivmedizinischesMonitoringKorpertemperaturComposition>(
              IntensivmedizinischesMonitoringKorpertemperaturComposition.class,
              "",
              "IntensivmedizinischesMonitoringKorpertemperaturComposition",
              IntensivmedizinischesMonitoringKorpertemperaturComposition.class,
              this);
  ...
  public ListSelectAqlField<KorpertemperaturObservation> KORPERTEMPERATUR =
      new ListAqlFieldImp<KorpertemperaturObservation>(
          IntensivmedizinischesMonitoringKorpertemperaturComposition.class,
  ...
  public SelectAqlField<String> BERICHT_ID_VALUE_TREE =
      new AqlFieldImp<String>(
          IntensivmedizinischesMonitoringKorpertemperaturComposition.class,
          "/context/other_context[at0001]/items[at0002]/name|value",
          "berichtIdValueTree",
          String.class,
          this);
  ...
  public static IntensivmedizinischesMonitoringKorpertemperaturCompositionContainment
      getInstance() {

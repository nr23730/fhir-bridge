...
public class KorpergrosseCompositionContainment extends Containment {
  public SelectAqlField<KorpergrosseComposition> KORPERGROSSE_COMPOSITION =
      new AqlFieldImp<KorpergrosseComposition>(
          KorpergrosseComposition.class,
          "",
          "KorpergrosseComposition",
          KorpergrosseComposition.class,
          this);

  public SelectAqlField<GrosseLangeObservation> GROSSE_LANGE =
      new AqlFieldImp<GrosseLangeObservation>(
          KorpergrosseComposition.class,
  ...
  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          KorpergrosseComposition.class, "/language", "language", Language.class, this);
  ...
  public SelectAqlField<Territory> TERRITORY =
      new AqlFieldImp<Territory>(
          KorpergrosseComposition.class, "/territory", "territory", Territory.class, this);
  ...
  public SelectAqlField<PartyProxy> COMPOSER =
      new AqlFieldImp<PartyProxy>(
          KorpergrosseComposition.class, "/composer", "composer", PartyProxy.class, this);
  ...
  public SelectAqlField<String> LOCATION =
      new AqlFieldImp<String>(
          KorpergrosseComposition.class, "/context/location", "location", String.class, this);

...
public class RaucherstatusCompositionContainment extends Containment {
  public SelectAqlField<RaucherstatusComposition> RAUCHERSTATUS_COMPOSITION =
      new AqlFieldImp<RaucherstatusComposition>(
          RaucherstatusComposition.class,
          "",
          "RaucherstatusComposition",
          RaucherstatusComposition.class,
          this);
  ...
  public SelectAqlField<Language> LANGUAGE =
      new AqlFieldImp<Language>(
          RaucherstatusComposition.class, "/language", "language", Language.class, this);
  ...
  public SelectAqlField<RaucherstatusEvaluation> RAUCHERSTATUS =
      new AqlFieldImp<RaucherstatusEvaluation>(
          RaucherstatusComposition.class,
          "/content[openEHR-EHR-EVALUATION.tobacco_smoking_summary.v1 and name/value='Raucherstatus']",
          "raucherstatus",
          RaucherstatusEvaluation.class,
          this);

  public SelectAqlField<Territory> TERRITORY =
      new AqlFieldImp<Territory>(
          RaucherstatusComposition.class, "/territory", "territory", Territory.class, this);
  ...
  public SelectAqlField<PartyProxy> COMPOSER =
      new AqlFieldImp<PartyProxy>(
          RaucherstatusComposition.class, "/composer", "composer", PartyProxy.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT =
      new AqlFieldImp<FeederAudit>(
          RaucherstatusComposition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);

  public SelectAqlField<String> LOCATION =
      new AqlFieldImp<String>(
          RaucherstatusComposition.class, "/context/location", "location", String.class, this);
